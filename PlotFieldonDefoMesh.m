function PlotFieldonDefoMesh(coordinates,nodes,factor,depl,component,lims,fig) 
%--------------------------------------------------------------------------
% Purpose:
...
%                               numbers
%                  fig - Wich number of figure you want.
%                  lims - Limits of value of variable to plot.               
%
